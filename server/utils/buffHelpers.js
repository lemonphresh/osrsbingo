...
const BUFF_CONFIGS = {
  ...
  universal_reduction: {
    ...
    reduction: 0.5,
    objectiveTypes: ['kills', 'xp_gain', 'item_collection', 'boss_kc', 'minigame', 'clue_scrolls'],
    icon: '✨',
  },
  multi_use_minor: {
    ...
    reduction: 0.25,
    objectiveTypes: ['kills', 'xp_gain', 'item_collection', 'boss_kc'],
    usesRemaining: 2,
    icon: '🔄',
  },
};
