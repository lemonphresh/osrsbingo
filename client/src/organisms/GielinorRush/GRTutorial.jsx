...
export const GRTutorial = ({
  ...
  const storageKey = `grush_tutorial_dismissed_${eventId}`;
...
export const StartNodeTutorial = ({ colorMode = 'dark', nodeId, eventId = 'default' }) => {
  const storageKey = `grush_startNode_tutorial_dismissed_${eventId}`;
  const [isDismissed, setIsDismissed] = useState(false);
