...
import GielinorRushActiveEvents from './GielinorRushActiveEvents';
...
const mockQuery = (events) => ({
  request: { query: GET_ALL_GR_EVENTS },
  result: { data: { getAllGREvents: events } },
});
...
describe('section headings', () => {
  it('always shows the "Live Now" heading', async () => {
    ...
    render(<GielinorRushActiveEvents />, {
