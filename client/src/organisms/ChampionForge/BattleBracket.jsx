...
function MatchCard({ match, teams, onSelectBattle }) {
  ...
  if (match.isBye) {
    return (
      <Box bg="gray.700" borderRadius="md" p={3} border="1px solid" borderColor="gray.600" minW="160px">
  ...
  return (
    <Box bg="gray.700" borderRadius="md" p={3} border="1px solid" borderColor="gray.600" minW="180px">
