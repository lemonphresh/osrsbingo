...
jest.mock('../../hooks/useContentRegistry', () => () => ({
  bossMetricOptions: [
    ...
    { value: 'chambers_of_xeric_challenge_mode', label: 'Challenge Mode Chambers of Xeric' },
    ...
    { value: 'maggot_king', label: 'Maggot King' },
    { value: 'nex', label: 'Nex' },
    ...
    { value: 'theatre_of_blood_hard_mode', label: 'Hard Mode Theatre of Blood' },
  ...
  clueMetricOptions: [
    ...
    { value: 'clue_scrolls_beginner', label: 'Beginner Clues' },
    { value: 'clue_scrolls_easy', label: 'Easy Clues' },
    { value: 'clue_scrolls_medium', label: 'Medium Clues' },
    { value: 'clue_scrolls_hard', label: 'Hard Clues' },
    { value: 'clue_scrolls_elite', label: 'Elite Clues' },
    { value: 'clue_scrolls_master', label: 'Master Clues' },
  ],
