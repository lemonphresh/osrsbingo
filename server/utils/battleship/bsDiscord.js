...
async function postBSPlacementStarted({ channelId, roleId, teamName, eventName, endsAt, eventId }) {
  ...
  await post(
    ...
    [
      ...
      `• Only complete shared suggestions count. If your team shares none, the site assigns all five ships as a valid random fleet.`,
...
async function postBSPlacementVoteReminder({ channelId, roleId, teamName, eventId }) {
  ...
  await post(
    ...
    [
      ...
      `If your team has no shared suggestion at the deadline, the site will assign all five ships randomly. Private workshop drafts do not count until shared.`,
