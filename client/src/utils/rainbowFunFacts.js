export const TILE_FUN_FACTS = {
  ...
  C1: {
    fact: "Red stands for Life on the original pride flag. Gilbert Baker chose it deliberately — queer people had just lived through years of loss and erasure, and claiming life as something worth celebrating was a statement. The red stripe is a reminder that survival itself is an act of resistance.",
    source: "GLBT Historical Society",
    sourceUrl: "https://www.glbthistory.org",
  },
  C2: {
    fact: "Orange stands for Healing on the original pride flag. Baker included it as an acknowledgment that the community was, and always would be, in the process of recovering — from violence, from grief, from the ongoing weight of living in a world that had not yet made space for them.",
    source: "GLBT Historical Society",
    sourceUrl: "https://www.glbthistory.org",
  },
  C3: {
    fact: "Yellow stands for Sunlight on the original pride flag. It's about visibility — being seen, stepping into the open after generations of being told to hide. Baker wanted the flag to be something you could see from a distance, something undeniable, and yellow carries that energy.",
    source: "GLBT Historical Society",
    sourceUrl: "https://www.glbthistory.org",
  },
  C4: {
    fact: "Green stands for Nature on the original pride flag. At a time when queer identity was routinely called unnatural, Baker's inclusion of green was a direct rebuttal. Queer people have always existed. The natural world is far more varied than the people trying to police it ever wanted to admit.",
    source: "GLBT Historical Society",
    sourceUrl: "https://www.glbthistory.org",
  },
  C5: {
    fact: "Blue stands for Magic and Art on the original pride flag, represented then by a turquoise stripe. Queer culture has always been deeply tied to art, performance, and the creation of beauty — often as a survival mechanism. Baker saw that as something worth naming and honoring in the flag itself.",
    source: "GLBT Historical Society",
    sourceUrl: "https://www.glbthistory.org",
  },
  C6: {
    fact: "Indigo stands for Serenity on the original pride flag. Not the serenity of having peace handed to you, but the kind you build yourself — the calm that comes from community, from finding people who see you, from not having to explain yourself anymore. Baker knew that was worth fighting for.",
    source: "GLBT Historical Society",
    sourceUrl: "https://www.glbthistory.org",
  },
  C7: {
    fact: "Violet stands for Spirit on the original pride flag. Baker was talking about the intangible thing that keeps a community together through loss and struggle — the part of queer identity that is deeper than politics or visibility, the sense that there is something worth carrying forward.",
    source: "GLBT Historical Society",
    sourceUrl: "https://www.glbthistory.org",
  },
};
