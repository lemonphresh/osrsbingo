...
import EventAdminManager from './GRAdminManager';
import GRRefManager from './GRRefManager';
                            ...
                            <Button
                              ...
                              onClick={() => {
                                if (Notification.permission === 'granted') {
                                  if (
                                    localStorage.getItem('grush_sound_enabled') !== 'false'
                                  ) {
