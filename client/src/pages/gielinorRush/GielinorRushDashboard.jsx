...
import CreateEventModal from '../../organisms/GielinorRush/CreateGREventModal';
import { GET_ALL_GR_EVENTS } from '../../graphql/queries';
import { useAuth } from '../../providers/AuthProvider';
import GemTitle from '../../atoms/GemTitle';
import { DELETE_GR_EVENT } from '../../graphql/mutations';
...
const GielinorRushDashboard = () => {
  ...
  const events = useMemo(() => data?.getAllGREvents || [], [data]);
...
export default GielinorRushDashboard;
