...
import { UPDATE_GR_TEAM, DELETE_GR_TEAM } from '../../graphql/mutations';
...
export default function EditTeamModal({
  ...
  const [updateTeam, { loading }] = useMutation(UPDATE_GR_TEAM, {
    onCompleted: () => {
  ...
  const [deleteTeam, { loading: deleteLoading }] = useMutation(DELETE_GR_TEAM, {
    onCompleted: () => {
