 ...
 * cfBattleSeeder.js
 *
 * Generates realistic CFBattleEvent log rows + championSnapshots for dev seeders.
 * Uses the real rollDamage / buildChampionStats logic so replays look authentic.
 *
 * Usage:
 *   const { simulateSeedBattle } = require('../../utils/cfBattleSeeder');
...
const { rollDamage, buildChampionStats } = require('./cfRandomisation');
