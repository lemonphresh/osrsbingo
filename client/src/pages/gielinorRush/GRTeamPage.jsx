...
import { GET_GR_EVENT_LEAN, GET_GR_TEAM, GET_ALL_SUBMISSIONS } from '../../graphql/queries';
...
import GRMapVisualization from '../../organisms/GielinorRush/GRMapVisualization';
import GemTitle from '../../atoms/GemTitle';
import BuffInventory from '../../organisms/GielinorRush/GRBuffInventory';
import { applyTeamBuffToNode } from '../../utils/grHelpers';
import { useAuth } from '../../providers/AuthProvider';
import { MdOutlineArrowBack } from 'react-icons/md';
import { useCallback } from 'react';
import GRTutorial from '../../organisms/GielinorRush/GRTutorial';
import AvailableInnsModal from '../../organisms/GielinorRush/AvailableInnsModal';
import BuffApplicationListModal from '../../organisms/GielinorRush/BuffApplicationListModal';
import TeamAccessOverlay from '../../organisms/GielinorRush/TeamAccessOverlay';
import EnhancedTeamStats from '../../organisms/GielinorRush/EnhancedTeamStats';
...
import DiscordLinkBanner from '../../molecules/GielinorRush/DiscordLinkBanner';
import EventStatusBanner from '../../organisms/GielinorRush/EventStatusBanner';
import { FaCog } from 'react-icons/fa';
import AvailableTasksStrip from '../../organisms/GielinorRush/AvailableTasksStrip';
import AllNodesAccordion from '../../organisms/GielinorRush/AllNodesAccordion';
import TeamHeroStrip from '../../organisms/GielinorRush/TeamHeroStrip';
...
const GRTeamView = () => {
  ...
  } = useQuery(GET_GR_EVENT_LEAN, { variables: { eventId } });

  const {
    data: teamData,
    loading: teamLoading,
    refetch: refetchTeam,
  } = useQuery(GET_GR_TEAM, { variables: { eventId, teamId } });
  ...
  const event = eventData?.getGREvent;
  const team = teamData?.getGRTeam;
  ...
  useSubscription(GR_ACTIVITY_SUB, {
    ...
    skip: !eventId,
    onData: ({ data }) => {
      const type = data?.data?.grActivity?.type;
  ...
  const handleApplyBuff = async (buffId) => {
    try {
      ...
      const freshNodeBuffs = freshTeamData?.getGRTeam?.nodeBuffs;
